    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        addButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String classChar = characterClassEditText.getText().toString();
                String race = characterRaceEditText.getText().toString();
                String level = characterLevelEditText.getText().toString();

                Character character = new Character(name, classChar, race, level, "0", "0", "0", "0", "0", "0");
